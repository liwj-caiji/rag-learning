...
class TemplateGenerator(Generator):
    ...
    def generate(
        ...
        if intent == "recommendation":
            ...
            return self._render_howto(context)
        elif intent == "ingredient":
            return self._render_ingredient(context)
        else:
    ...
    def _render_howto(self, context: List[Dict]) -> str:
        if not context:
    ...
    def _render_ingredient(self, context: List[Dict]) -> str:
        if not context:
